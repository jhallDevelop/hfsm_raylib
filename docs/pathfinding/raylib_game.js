...
function findWasmBinary() {
    return locateFile('raylib_game.wasm');
}
...
var ASM_CONSTS = {
  60788: () => { if (document.fullscreenElement) return 1; },  
 60834: () => { return Module.canvas.width; },  
 60866: () => { return parseInt(Module.canvas.style.width); },  
 60914: () => { document.exitFullscreen(); },  
 60941: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 61014: () => { if (document.fullscreenElement) return 1; },  
 61060: () => { return Module.canvas.width; },  
 61092: () => { return screen.width; },  
 61117: () => { document.exitFullscreen(); },  
 61144: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 61277: () => { return window.innerWidth; },  
 61303: () => { return window.innerHeight; },  
 61330: () => { if (document.fullscreenElement) return 1; },  
 61376: () => { return Module.canvas.width; },  
 61408: () => { return parseInt(Module.canvas.style.width); },  
 61456: () => { if (document.fullscreenElement) return 1; },  
 61502: () => { return Module.canvas.width; },  
 61534: () => { return screen.width; },  
 61559: () => { return window.innerWidth; },  
 61585: () => { return window.innerHeight; },  
 61612: () => { if (document.fullscreenElement) return 1; },  
 61658: () => { return Module.canvas.width; },  
 61690: () => { return screen.width; },  
 61715: () => { document.exitFullscreen(); },  
 61742: () => { if (document.fullscreenElement) return 1; },  
 61788: () => { return Module.canvas.width; },  
 61820: () => { return parseInt(Module.canvas.style.width); },  
 61868: () => { document.exitFullscreen(); },  
 61895: ($0) => { Module.canvas.style.opacity = $0; },  
 61933: () => { return screen.width; },  
 61958: () => { return screen.height; },  
 61984: () => { return window.screenX; },  
 62011: () => { return window.screenY; },  
 62038: () => { return window.devicePixelRatio; },  
 62074: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 62127: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 62178: () => { Module.canvas.style.cursor = 'none'; },  
 62215: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 62471: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 62522: () => { if (document.fullscreenElement) return 1; },  
 62568: () => { return window.innerWidth; },  
 62594: () => { return window.innerHeight; },  
 62621: () => { if (document.pointerLockElement) return 1; }
};
