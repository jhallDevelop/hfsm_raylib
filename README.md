...
This example provides a worked example in c++ of how a hierarchical finite state machine might work. The repo is also pre-configured with a default `LICENSE` (zlib/libpng) and a `README.md` (this one) to be properly filled by users. Feel free to change the LICENSE as required.
...
![$(HFSM)](screenshots/screenshot000.png "$(HFSM)")
